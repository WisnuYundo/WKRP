...
stock House_Spawn(i)
{
	...
	{
		format(string, sizeof(string), "[ID: %d]\n{33CC33}This house for sell\n{FFFFFF}Address: {FFFF00}%s\n{FFFFFF}Price: {FFFF00}$%s\n{FFFFFF}Type /house buy to purchase", i, GetLocation(HouseData[i][housePos][0], HouseData[i][housePos][1], HouseData[i][housePos][2]), FormatNumber(HouseData[i][housePrice]));
	...
	{
		format(string, sizeof(string), "[ID: %d]\n{FFFFFF}Owner: {FFFF00}%s\n{FFFFFF}Address: {FFFF00}%s\n{FFFFFF}Press {FF0000}ENTER {FFFFFF}to enter house", i, HouseData[i][houseOwnerName], GetLocation(HouseData[i][housePos][0], HouseData[i][housePos][1], HouseData[i][housePos][2]));
		HouseData[i][houseText3D] = CreateDynamic3DTextLabel(string, 0x007FFFFF, HouseData[i][housePos][0], HouseData[i][housePos][1], HouseData[i][housePos][2], 7.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, HouseData[i][houseExteriorVW], HouseData[i][houseExterior]);
        HouseData[i][housePickup] = CreateDynamicPickup(1272, 23, HouseData[i][housePos][0], HouseData[i][housePos][1], HouseData[i][housePos][2], HouseData[i][houseExteriorVW], HouseData[i][houseExterior]);
...
stock House_Create(playerid, price, type)
{
	...
	if (GetPlayerPos(playerid, x, y, z) && GetPlayerFacingAngle(playerid, angle))
	{
        ...
        {
            HouseData[i][houseInt][0] = 1398.5334;
            HouseData[i][houseInt][1] = 1460.9841;
            HouseData[i][houseInt][2] = 10010.9063;
            HouseData[i][houseInt][3] = 84.7244;
			HouseData[i][houseInterior] = 8;    	        	
        }
        else if(type == 4)
        {
            HouseData[i][houseInt][0] = 1497.9545;
            HouseData[i][houseInt][1] = 1378.3165;
            HouseData[i][houseInt][2] = 1010.9569;
            HouseData[i][houseInt][3] = 264.2875;
